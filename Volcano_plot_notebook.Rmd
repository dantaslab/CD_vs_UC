...
volcano_plot <- GWAS_cutoff %>% ggplot(aes(x=`Beta`, y=`scaled_pvalue`, label=Name)) + geom_point(aes(color=cutoff_type), size=.8)+ scale_color_brewer(palette="Dark2")+geom_text(hjust=.5, vjust=-.5, size=2.1)+ylab("-Log10 P")
volcano_plot
```
